  ...
  return (
    <div className="auth">
      <div className="auth__box">
        ...
        <p className="muted">
          {/* Ver o comentario equivalente no AuthGate do organizador: o codigo
              interno da regra nao pertence a tela de acesso. */}
          Todo perfil de Super Admin exige verificação em duas etapas.
        </p>
