 ...
 * Porteiro de sessao.
 *
 * Enquanto a sessao nao estiver COMPLETA — autenticada e, quando o perfil
 * exigir, com o segundo fator satisfeito (RN12) — nenhuma tela do painel e
 * montada. Isso evita a tela aparecer e so depois quebrar em 403.
 *
  ...
  return (
    <div className="auth">
      <form className="auth__box" onSubmit={handleSubmit}>
        ...
        <p className="muted">Entre com a conta da sua comunidade.</p>
  ...
  return (
    <div className="auth">
      <div className="auth__box">
        ...
        <p className="muted">
          {/* Sem o codigo interno da regra: "RN12" nomeia um requisito do
              nosso documento de negocio e nao diz nada a quem esta tentando
              entrar. Quem le uma sigla desconhecida numa tela de acesso
              costuma achar que deu erro. */}
          Seu perfil exige verificação em duas etapas para acessar o painel.
        </p>
