...
export function TeamPage() {
  ...
  return (
    <>
      ...
      {/* `.table-wrap` e obrigatorio junto de `.table`: a classe tem
          `min-width: 620px`, e sem o invólucro que rola na horizontal esta
          matriz de permissoes estouraria a largura da tela no celular. */}
